...
<head>
    ...
    <meta name="Alvarez Salazar" content="">
                    ...
                    <div class="col-sm-6">
                        <div class="contactinfo">
                            <ul class="nav nav-pills">
                                <li><a href="#"><i class="fa fa-phone"></i> +52 618 689 432</a></li>
                                <li><a href="#"><i class="fa fa-envelope"></i>Danielalvsz@gmail.com</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-sm-6">
                    ...
                    <div class="col-sm-8">
                        ...
                        <div class="shop-menu pull-right">
                            <ul class="nav navbar-nav">
                                ...
                                <li><a href="checkout.php"><i class="fa fa-shopping-cart"
                                ></i> Carrito</a></li>
